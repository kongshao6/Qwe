...
-- 等待验证通过（现在 isVerified 会立即被设为 true）
...
if not success then
    ...
    errLabel.Size = UDim2.new(0, 500, 0, 100)
    errLabel.Position = UDim2.new(0.5, -250, 0.5, -50)
    errLabel.Text = "主脚本加载失败，请检查网络或控制台错误。\n" .. tostring(err)
    errLabel.TextColor3 = Color3.fromRGB(255, 0, 0)
    errLabel.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    errLabel.BackgroundTransparency = 0.5
